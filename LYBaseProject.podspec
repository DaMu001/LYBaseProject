#
#  Be sure to run `pod spec lint LYBaseProject.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "LYBaseProject"
  spec.version      = "0.0.1"
  spec.summary      = "项目的基础配置集合"
  ...
  spec.source_files  = "LYBaseProject/Classes", "LYBaseProject/Classes/**/*.{h,m}"
  spec.exclude_files = "Classes/Exclude"

  spec.public_header_files = "LYBaseProject/Classes/**/*.h"
